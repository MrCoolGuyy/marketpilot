...
class EvidenceTraceabilityReadModel(BaseModel):
    ...
    # PHASE 5 PORTFOLIO ADMISSION
    is_admitted: Optional[bool] = None
    allocation_id: Optional[str] = None
    allocation_rejection_reason: Optional[str] = None
    approved_risk: Optional[str] = None

# ==============================================================================
# PORTFOLIO STATE
# ==============================================================================

class PortfolioStateProjection(BaseModel):
    """Read-only view of the exposure manager and equity."""
    snapshot_timestamp: float
    total_equity: str
    available_balance: str

    total_risk_amount: str
    portfolio_heat_ratio: str

    active_positions_count: int
    reserved_allocations_count: int

    active_position_ids: list[str]
    reserved_allocation_ids: list[str]
